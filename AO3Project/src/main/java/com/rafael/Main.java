...
public class Main extends Application {
    ...
    private HBox createTopBar() {
        ...
        Hyperlink fandoms = new Hyperlink("Fandoms");
        fandoms.setOnAction(e -> setCenterContent(new FandomPage().getView()));

        Hyperlink homeLink = new Hyperlink("Home");
        homeLink.setOnAction(e -> setCenterContent(new HomeView().getView()));
        ...
        topBar.getChildren().addAll(menuButton, logo, title, spacer, themeToggle, homeLink, fandoms, browse, search, about, searchField);
        return topBar;
    }
